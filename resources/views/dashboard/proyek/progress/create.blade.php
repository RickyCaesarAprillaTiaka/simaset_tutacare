...
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">Tambah Progress</h3>
    ...
    <div class="box-body">
        <div class="row">
            <div class="col-xs-6">
                {!! Form::open(array('route' => ['dashboard.proyek.progress.store', 'id_proyek' => $proyek->id],
                'method' => 'POST', 'enctype' => 'multipart/form-data')) !!}
                {{ Form::tutaText('lokasi', old('lokasi'), '*', ['required' => 'required'], 'Lokasi') }}
                {{ Form::tutaText('progress', old('progress'), '*', ['required' => 'required'], 'Progress') }}
                ...
                {{ Form::tutaText('persentase', old('persentase'), '*', ['required' => 'required'], 'Persentase') }}
            </div>
        </div>
        <div class="row">
            <div class="col-xs-12">
