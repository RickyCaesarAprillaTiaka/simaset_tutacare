...
<li class="active">Schedule Proyek</li>
@endsection
...
<div class="box">
	<div class="box-header">
		<h3 class="box-title">
		<a href="{{route('dashboard.proyek.schedule.create', ['id_proyek' => $proyek->id])}}" class="btn btn-primary btn-sm" id="btn-add"><i class="fa fa-plus"></i> Tambah Schedule</a>
		...
		<table id="cdata" class="table table-bordered table-striped">
			...
			<tbody>
                ...
                <tr>
                    ...
                    <td>
                        {!! Form::open(['route' => ['dashboard.proyek.schedule.destroy', 'id_proyek' => $proyek->id, 'id_schedule' => $value->id], 'method' => 'delete']) !!}
			            <a href="{!! route('dashboard.proyek.schedule.edit', ['id_proyek' => $proyek->id, 'id_schedule' => $value->id]) !!}" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-edit"></i></a>
