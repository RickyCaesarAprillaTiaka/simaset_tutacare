...
<div class="box">
	<div class="box-header">
		<h3 class="box-title">
		<a href="/dashboard/jenis/create" class="btn btn-primary btn-sm" id="btn-add"><i class="fa fa-plus"></i> Buat Jenis Baru</a>
		</h3>
	</div>
	<!-- /.box-header -->
	<div class="box-body">
		<table id="cdata" class="table table-bordered table-striped">
			...
			<tbody>
				...
				<tr>
					...
					<td>{{ $value->name }}</td>
          <td>
			            {!! Form::open(['route' => ['dashboard.jenis.destroy', $value->id], 'method' => 'delete']) !!}
			            <a href="{!! route('dashboard.jenis.edit', $value->id) !!}" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-edit"></i></a>
