...
<body class="hold-transition skin-blue sidebar-mini sidebarbody">
<div class="wrapper">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <li class="dropdown user user-menu">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
          <img src="/user/img/{{Auth::user()->foto}}" class="user-image" alt="User Image">
          <span class="hidden-xs">{{Auth::user()->name}}</span>
        </a>
        <ul class="dropdown-menu">
          <!-- User image -->
          <li class="user-header">
            <img src="/user/img/{{Auth::user()->foto}}" class="img-circle" alt="User Image">
          ...
          <li class="user-footer">
            <div class="pull-left">
              <a href="/dashboard/profile" class="btn btn-primary btn-flat">Profile</a>
            </div>
...
@include('layouts.sidebar')
  ...
  <div class="content-wrapper">
    ...
    <footer class="main-footer">
      ...
      <strong>PT.GRAHA INTI KREASI INDO.
    </footer>
  </div>
  <!-- ./wrapper -->
